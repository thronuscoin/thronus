...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s thronus-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  thronus-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded thronus transaction") + "\n" +
              "  thronus-tx [options] -create [commands]   " + _("Create hex-encoded thronus transaction") + "\n" +
              "\n";
