...
const char * const BITCOIN_CONF_FILENAME = "thronus.conf";
const char * const BITCOIN_PID_FILENAME = "thronus.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Thronus";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Thronus";
#else
    // Unix
    return pathRet / ".thronus";
#endif
#endif
}
