...
{
    const char* pszTimestamp = "BBC News 08/July/2019 AI pilot sees runway and lands automatically";
    const CScript genesisOutputScript = CScript() << ParseHex("0428DB16589D61FB281A73F4FE80C46F7B3BE8DC3FBEA9E6BB32182325FE04A1E42734608836BBB810EC04D5556D0D5B9B6F7EC4FD958ECC0CFA1ABD3D65596F47") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1562629748, 569965, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd5340295597f970540641d0899ca7de201db5abe9e06eb4fd7fbc620da2d9680"));
        assert(genesis.hashMerkleRoot == uint256S("0x115573f97155f5c4f7066512d484ae87fcb36c0f4e9d74447dfe912617a4ed53"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.thronus.loshan.co.uk", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("thronustools.com", "dnsseed.thronustools.com"));
        //vSeeds.push_back(CDNSSeedData("thronuspool.org", "dnsseed.thronuspool.org"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 1782624, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xac843b6fdec11df7a5ba997c9925507cf42d78605c0a84bf72df0dd1776cd455"));
        assert(genesis.hashMerkleRoot == uint256S("0x115573f97155f5c4f7066512d484ae87fcb36c0f4e9d74447dfe912617a4ed53"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.push_back(CDNSSeedData("thronustools.com", "testnet-seed.thronustools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.thronus.loshan.co.uk", true));
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x52589a678752573281fe96a318ca5f2aac2d77b40df6dcf89bd782cb413f28b4"));
        assert(genesis.hashMerkleRoot == uint256S("0x115573f97155f5c4f7066512d484ae87fcb36c0f4e9d74447dfe912617a4ed53"));
